...
def get_link():
    ...
    msg_ineligible = "<br>Sorry, you are ineligible to participate in this survey this time. Thank you very much for your interest."  ## XXX Chinese translation needed
    msg_maxnum_cohort = "<br>次轮招募已完成，我们将在下轮开始时尽快联系您！" ## XXX Google translate says "the second round of recuitment has been completed". If this is correct translation, can we say "this round" instead of "the second round"?
    msg_initial = "<br>此次调研总共维持6天时间。我们将在接下来的8天（包括今天）每天提供一些上海本地及周边的户外活动及场所的信息。根据参与者的意向，我们或将于 [Sep 30 - Oct 4 2019] 组团结伴前往。<br><br>\
