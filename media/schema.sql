...
'步行4000-7000步。 我们将代表您向上海联合基金会捐款！独自行走或与您的朋友和家人一起散步，并使用微信步数记录您步数！', 23, 31,
1,1,1,0,0,1,
'我们对上海联劝公益基金会进行捐款。联劝全称是联合劝募，是以社会问题为导向，集结众多公益组织，自下而上开展劝募活动，并通过高度问责的方式将募集到的慈善资源统筹分配给公益组织，以打通民间公益组织与慈善资源之间的壁垒——每个普通人都可以用不同方式参与到公益中。联劝坚持在复杂的价值碰撞中，为公众带来快乐的公益体验；坚持在瞬息万变的社会里，为公众提供多元的公益参与；坚持在冲动的消费时代中，理性地支持公益，支持理性的公益。',
'2019年5月13-19日', '2019年5月18日', '五月13至19日',
2);
